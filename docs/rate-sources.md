...
| --------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| SBI Remit       | IDR PHP VND NPR CNY THB                                                                          | `POST https://www.remit.co.jp/kaigaisoukin/exchangeratecommission/exchange/` (form `currency=<CCY>&mode=receive&base=JPY`, one call per currency)                                                                                                                                                                                          | adapter (`src/lib/sources/sbi-remit.ts`)                                                                         | API already per-1-JPY incl. CNY/THB (live-verified 2026-08-23; page _display_ uses `data-rate` multipliers — CNY/USD/BRL only — which do NOT apply to the API)     | 12 h KV         | **observed** (INR, BDT: board returns `rate:null` → modeled)                                                                                                                                                       | IDR **verified** (task 8); others illustrative                                                               |
...
| Revolut Japan   | all                                                                                              | —                                                                                                                                                                                                                                                                                                                                          | —                                                                                                                | —                                                                                                                                                                  | —               | modeled — **relabeled** "per published terms (weekday interbank + 1 % weekend)" via `modeledSourceLabel` (task 21); Cloudflare-walled, never observed                                                              | illustrative                                                                                                 |
...
| Kyodai          | IDR                                                                                              | `src/data/manual-rates.ts` — value read off `https://www.kyodai.co.jp/` in a browser 2026-08-23 (1 ¥ = 111.1000 IDR); their board is Blazor Server + digit-image digits — not HTTP-automatable                                                                                                                                             | manual entry (checked in, task 21; never KV-cached; ≥ 24 h → expired → modeled until a human refreshes the file) | per-1-JPY                                                                                                                                                          | bundle (no TTL) | **manual** (browser-captured 2026-08-23)                                                                                                                                                                           | IDR **verified** (task 8); others illustrative                                                               |
...
| JRF           | bank (acc_depo) | <¥60k → ¥850 · <¥300k → ¥1,450 · ≤¥1M → ¥1,950 (own fee API `/api/country/service/fee/all`, Indonesia, 2026-08-23) |
